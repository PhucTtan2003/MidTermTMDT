...
namespace MyEStore.Migrations
{
    ...
    [Migration("20241116121722_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEStore.Entities.ChiTietHd", b =>
                {
                    b.Property<int>("MaCt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyEStore.Entities.ChuDe", b =>
                {
                    b.Property<int>("MaCd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyEStore.Entities.GopY", b =>
                {
            ...
            modelBuilder.Entity("MyEStore.Entities.HangHoa", b =>
                {
                    b.Property<int>("MaHh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyEStore.Entities.HoiDap", b =>
                {
                    b.Property<int>("MaHd")
                        .HasColumnType("int")
                        .HasColumnName("MaHD");
            ...
            modelBuilder.Entity("MyEStore.Entities.KhachHang", b =>
                {
                    b.Property<string>("MaKh")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("MyEStore.Entities.Loai", b =>
                {
                    b.Property<int>("MaLoai")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEStore.Entities.NhaCungCap", b =>
                {
                    b.Property<string>("MaNcc")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("MyEStore.Entities.NhanVien", b =>
                {
                    b.Property<string>("MaNv")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("MyEStore.Entities.PhanCong", b =>
                {
                    b.Property<int>("MaPc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyEStore.Entities.PhanQuyen", b =>
                {
                    b.Property<int>("MaPq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyEStore.Entities.PhongBan", b =>
                {
                    b.Property<string>("MaPb")
                        .HasMaxLength(7)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("MyEStore.Entities.TrangThai", b =>
                {
                    b.Property<int>("MaTrangThai")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEStore.Entities.TrangWeb", b =>
                {
                    b.Property<int>("MaTrang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEStore.Entities.VChiTietHoaDon", b =>
                {
                    b.Property<double>("DonGia")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MyEStore.Entities.YeuThich", b =>
                {
                    b.Property<int>("MaYt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyEStore.Entities.BanBe", b =>
                {
                    b.HasOne("MyEStore.Entities.HangHoa", "MaHhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaHh")
                    ...
                    b.HasOne("MyEStore.Entities.KhachHang", "MaKhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaKh")
            ...
            modelBuilder.Entity("MyEStore.Entities.ChiTietHd", b =>
                {
                    b.HasOne("MyEStore.Entities.HoaDon", "MaHdNavigation")
                        .WithMany("ChiTietHds")
                        .HasForeignKey("MaHd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("MyEStore.Entities.ChuDe", b =>
                {
                    b.HasOne("MyEStore.Entities.NhanVien", "MaNvNavigation")
                        .WithMany("ChuDes")
                        .HasForeignKey("MaNv")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("MyEStore.Entities.GopY", b =>
                {
                    b.HasOne("MyEStore.Entities.ChuDe", "MaCdNavigation")
                        .WithMany("Gopies")
                        .HasForeignKey("MaCd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("MyEStore.Entities.HangHoa", b =>
                {
                    b.HasOne("MyEStore.Entities.Loai", "MaLoaiNavigation")
                        .WithMany("HangHoas")
                    ...
                    b.HasOne("MyEStore.Entities.NhaCungCap", "MaNccNavigation")
                        .WithMany("HangHoas")
                        .HasForeignKey("MaNcc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("MyEStore.Entities.HoaDon", b =>
                {
                    ...
                    b.HasOne("MyEStore.Entities.TrangThai", "MaTrangThaiNavigation")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("MyEStore.Entities.PhanCong", b =>
                {
                    ...
                    b.HasOne("MyEStore.Entities.PhongBan", "MaPbNavigation")
                        .WithMany("PhanCongs")
                        .HasForeignKey("MaPb")
                        .IsRequired()
            ...
            modelBuilder.Entity("MyEStore.Entities.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("MyEStore.Entities.TrangWeb", "MaTrangNavigation")
                        .WithMany("PhanQuyens")
